  ...
  **제어권을 개발자 몫이 아닌 Framework 의 몫으로 이관**
  ...
  또한, 과거 레가시 코드를 포팅하기에도 수월하며, 퍼블리셔의 작업물과 문제없이 부드럽게 합쳐진다.
    ...
    - **Incremental DOM**
        ...
        - 전환 후 빌드 과정중에 **트리 쉐이킹(Tree Shaking) 수행**
           ...
           ![Untitled (4)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/1dd2fb37-ffae-4392-a3a9-02cf3c04a6b4)
    ...
    **Dependencies**(패키지, 라이브러리) 와 **Source Code**(소스 코드) 를 분리하여 번들링
    ...
    ![Untitled (5)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/742b69ee-e770-40a1-ab25-3f5c990a501d)
  ...
  ### 프론트엔드 개발 시 CSS 활용
    ...
    - CSS Architecture : **BEM (Block Element Modifier)**
     ...
     ![Untitled (6)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/b5e84d21-a073-4f84-9a59-08d6bbfda530)
  ...
  ### React 다양한 Hook 및 서드파티 라이브러리
        ...
        - 구현 및 사용 방법
            - **3 절차** : **createContext** (DefaultValue) → **Provider** (InitialValue) → **useContext**
                ...
                - **React.useContext(CreatedContext)** : Provider 내부에서 InitialValue 호출 사용
                  ...
                  <img width="719" alt="Untitled (10)" src="https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/3a169ded-a3c1-420f-b215-6403e7f2488d">
    ...
    - 비제어 요소 (예, DOM) 관리 Hook : **useRef**
        ...
        - React 를 통해 값이 제어되는 입력 폼 요소 = **제어 컴포넌트(Controlled Component)**
            - 문제점 : 값을 입력하는 족족히 ****빈번한 Rerender****
              ...
              ![Untitled (13)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/1977de38-9650-43b7-a4fb-1cac225d5f64)

        - Javascript 를 통해 값이 제어되는 입력 폼 요소 = **비제어 컴포넌트(Uncontrolled Component)**
    ...
    - **iTerm 설정하기** : 주니어 개발자로는 별로 쓸일이 없겠지만, 훗날 Git + CI/CD 작업시 필요
        ...
        - 설정 참조 스크린샷
         ...
         ![Untitled (14)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/253ad8b0-dfa0-4508-b7b4-e09029ccbd58)


          ![Untitled (15)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/ce1fd798-8c8c-45b9-9238-637672428dd7)
    ...
    - **VSCode 설정하기 (맥북 기준)**
        ...
        - **이후 커서로 이동 : Control + Shift + -** (intellij Keybinding 설치 시 Command + ])
            - 참조 스크린샷 : 이전 커서 / 이후 커서 이동 키가 Windows 에서는 아래와 같음
              ...
              ![Untitled (16)](https://github.com/TaskerJang/ASAC-3rd-Study/assets/124780552/f8da5768-3207-44b0-ada3-26fe02d4fc4e)
